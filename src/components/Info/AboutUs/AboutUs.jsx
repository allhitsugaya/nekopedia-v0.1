            ...
            <Container maxWidth="lg">
                ...
                <Box sx={{ mb: 8 }}>
                    <Box sx={{ display: 'flex', alignItems: 'center', mb: 3 }}>
                        <CodeIcon sx={{ fontSize: 40, color: 'primary.dark', mr: 2, opacity: 0.8 }} />
                    ...
                    <List sx={{
                        ...
                        <ListItem sx={{ alignItems: 'flex-start', py: 2 }}>
                            <SchoolIcon sx={{ color: 'primary', mr: 2, mt: '3px', opacity: 0.8 }} />
                            <Box>
                        ...
                        <ListItem sx={{ alignItems: 'flex-start', py: 2 }}>
                            <UpdateIcon sx={{ color: 'primary', mr: 2, mt: '3px', opacity: 0.8 }} />
                            <Box>
                                <Typography component="span" sx={{ fontWeight: 700, display: 'block', mb: 1 }}>
                        ...
                        <Divider component="li" sx={{ borderColor: 'rgba(162, 217, 206, 0.1)' }} />
                        <ListItem sx={{ alignItems: 'flex-start', py: 2 }}>
                            <GroupIcon sx={{ color: 'primary', mr: 2, mt: '3px', opacity: 0.8 }} />
                            <Box>
                                <Typography component="span" sx={{ fontWeight: 700, display: 'block', mb: 1 }}>
