...
console.log("Результат множення:", result2); // 28
          `}
            ...
            <div className='conclusion'>
                <h2>Заключення</h2>
                <p>
                    Поліморфізм та абстракція є важливими принципами об'єктно-орієнтованого програмування. Поліморфізм
                    дозволяє об'єктам різних класів використовувати однаковий інтерфейс, що спрощує роботу з ними.
                    Абстракція дозволяє приховувати зайві деталі реалізації, надаючи зручний інтерфейс для взаємодії з
                    об'єктами. Використання цих принципів робить код більш структурованим, зрозумілим та підтримуваним.
                </p>
            </div>
        </div>
    );
