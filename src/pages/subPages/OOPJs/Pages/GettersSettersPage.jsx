...
// Виведе "Вік не може бути від'ємним."
          `}
            ...
            <div className='conclusion'>
                <h2>Заключення</h2>
                <p>
                    Гетери та сетери є важливим інструментом у JavaScript, який дозволяє контролювати доступ до
                    властивостей об'єктів. Вони забезпечують безпеку даних, дозволяють валідувати введені значення та
                    спрощують роботу з об'єктами. Використання гетерів та сетерів робить код більш структурованим,
