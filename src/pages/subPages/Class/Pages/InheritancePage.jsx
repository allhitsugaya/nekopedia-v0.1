...
const InheritancePage = () => {
    return (
        <Box sx={{ padding: 2 }}>
            ...
            <Paragraph>
                Спадкування в програмуванні - це механізм, що дозволяє класу (підкласу) успадковувати властивості та методи іншого класу (батьківського класу). У JavaScript цей механізм реалізується за допомогою ключового слова <Code>extends</Code>. Давайте детальніє розглянемо, як працює спадкування класів у JavaScript.
            </Paragraph>
