...
const SessionStoragePage = () => {
    return (
        <Container>
            <SubHeader variant="h2">SessionStorage</SubHeader>
            ...
            <SubHeader variant="h2">LocalStorage vs. SessionStorage</SubHeader>
            ...
            <SubHeader variant="h2">Практичний приклад використання SessionStorage</SubHeader>
...
document.getElementById("colorPicker").addEventListener("change", function (event) {
    ...
    document.body.style.backgroundColor = selectedColor;
            ...
            <Conclusion variant="h2">Заключення</Conclusion>
