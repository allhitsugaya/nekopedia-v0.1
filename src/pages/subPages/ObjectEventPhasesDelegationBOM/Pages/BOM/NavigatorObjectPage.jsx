...
if (userLanguage.startsWith("en")) {
    ...
    // Вибрати мову за замовчуванням
            ...
            <div className='conclusion'>
                <h2>Висновок</h2>
                <p>
                    Об'єкт <code>navigator</code> є потужним інструментом для веб-розробників, який надає інформацію про
                    браузер та пристрій користувача. Ця інформація може бути використана для створення більш адаптивних
                    та користувацьких веб-додатків. Розуміння роботи з об'єктом <code>navigator</code> допомагає
                    розробникам створювати додатки, які можуть працювати оптимально на різних браузерах і платформах.
                </p>
            </div>
        </div>
    );
