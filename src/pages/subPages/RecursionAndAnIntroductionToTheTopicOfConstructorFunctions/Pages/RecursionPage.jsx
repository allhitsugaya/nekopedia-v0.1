...
console.log(sumArray(numbers, numbers.length - 1)); // Виведе 15 (1 + 2 + 3 + 4 + 5)
          `}
            ...
            <div className='conclusion'>
                <h2>Заключення</h2>
                <p>
                    Рекурсія - це потужний інструмент, який допомагає розв'язувати складні завдання шляхом розкладання
                    їх на менші частини. Вона використовується в багатьох аспектах програмування і може значно полегшити
                    розробку програм. Тим не менше, рекурсія повинна використовуватися ретельно, оскільки некоректно
                    написана рекурсивна функція може призвести до переповнення стеку і викликів функцій.
                </p>
            </div>
        </div>
    );
