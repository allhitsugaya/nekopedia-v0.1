...
const SwitchCasePage = () => {
    return (
        <Container>
            <BookHeader variant="h2" component="h2">Умовна конструкція switch/case</BookHeader>
            <Paragraph>
            ...
            <SubHeader variant="h2" component="h2">Синтаксис switch/case</SubHeader>
            <Paragraph>
...
switch (вираз) {
    ...
    default:
        // Код, що виконується, якщо жоден варіант не підходить
            ...
            <SubHeader variant="h2" component="h2">Важливі аспекти switch/case</SubHeader>
            <List dense>
                <ListItem>
                    <ListItemText
            ...
            <SubHeader variant="h2" component="h2">Приклади використання</SubHeader>

            <SubHeader variant="h3" component="h3">День тижня</SubHeader>
            <CodeBlock>
                {`
let day = "п'ятниця";
let message;
...
console.log(message);
            ...
            <SubHeader variant="h3" component="h3">Вибір операції</SubHeader>
            <CodeBlock>
                {`
...
console.log(\`Результат: \${result}\`);
            ...
            <>
                <SubHeader variant="h2" component="h2">Заключні слова</SubHeader>
                <Paragraph>
