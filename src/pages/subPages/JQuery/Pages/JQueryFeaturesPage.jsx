...
const JQueryFeaturesPage = () => {
    return (
        <Container>
            <SubHeader variant="h6" component="h6">Базові можливості jQuery</SubHeader>
            ...
            <Box component="section">
                <Chapter variant="h6" component="h6">1. Вибір елементів за допомогою CSS-подібного синтаксису</Chapter>
                <Paragraph>
...
$('li:first');`}
            ...
            <Box component="section">
                <Chapter variant="h6" component="h6">2. Зміна вмісту та стилів елементів</Chapter>
                <Paragraph>
...
$('#myElement').removeClass('inactive');`}
            ...
            <Box component="section">
                <Chapter variant="h6" component="h6">3. Обробка подій</Chapter>
                <Paragraph>
...
$('#myInput').on('input', function() {
  console.log('Введений текст:', $(this).val());
            ...
            <Box component="section">
                <Chapter variant="h6" component="h6">4. Анімації</Chapter>
                <Paragraph>
...
$('#myElement').animate({ marginLeft: '+=100px' }, 1000);`}
            ...
            <Box component="section">
                <Chapter variant="h6" component="h6">5. Робота з AJAX</Chapter>
                <Paragraph>
...
$.ajax({
  ...
  error: function(error) {
    console.error('Помилка:', error);
            ...
            <Box component="section">
                <Chapter variant="h6" component="h6">6. Фільтрація та пошук елементів</Chapter>
                <Paragraph>
...
$('#myElement').prev();`}
            ...
            <Box component="section">
                <Chapter variant="h6" component="h6">7. Додавання та видалення елементів</Chapter>
                <Paragraph>
...
$('#myElement').empty();`}
            ...
            <Box component="section">
                <Chapter variant="h6" component="h6">8. Практичне використання jQuery</Chapter>
                <Paragraph>
...
$('#myButton').click(function() {
  ...
  $.get('https://api.example.com/data', function(response) {
    console.log('Дані отримано:', response);
            ...
            <Box component="section">
                <SubHeader variant="h6" component="h6">Чому jQuery залишається популярним?</SubHeader>
                <Paragraph>
