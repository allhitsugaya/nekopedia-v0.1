...
function calculateDiscountedPrice(quantity, discount) {
  ...
  return discount > 0.5 ? price + 5 : price // Нема if, менше вірогідність опечатки
            ...
            <h2>Висновок</h2>
            <p>
                Чистий код важливий, оскільки він полегшує читабельність, підтримку, розширення і допомагає уникнути помилок. Розробники, які дотримуються принципів чистого коду, стають більш продуктивними та забезпечують більшу якість свого програмного забезпечення.
            </p>
        </div>
    );
};
