...
for (let i = 0; i < numbers.length; i++) {
    ...
    console.log(numbers[i]);
          ...
          `}
            ...
            <h2>Висновок</h2>
            <p>
                Ключові слова <code>break</code> та <code>continue</code> дозволяють керувати виконанням циклів в JavaScript. Вони роблять код більш гнучким і дозволяють виходити з циклів або пропускати окремі ітерації на основі певних умов. Розуміння їхнього використання робить вас більш ефективним розробником, оскільки ви можете писати більш читабельний та продуктивний код.
            </p>
        </div>
    );
};
