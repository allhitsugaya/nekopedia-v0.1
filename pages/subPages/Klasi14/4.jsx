...
class Dog extends Animal {
  ...
  // Решта коду...
          ...
          `}
            ...
            <h2>Заключення</h2>
            <p>
                Спадкування є важливим механізмом у програмуванні, який дозволяє створювати ієрархії класів, успадковувати властивості та методи, а також розширювати функціональність. Використання ключового слова <code>extends</code> та <code>super</code> робить код більш структурованим, зрозумілим та підтримуваним.
            </p>
        </div>
    );
};
