...
console.log(\`Результат: \${result}\`);
          `}
            ...
            <p>
                Умовна конструкція <code>switch/case</code> є потужним інструментом для обробки різних варіантів значень у вашому коді. Вона дозволяє писати більш читабельний код для обробки багатьох сценаріїв. Пам'ятайте про важливість <code>break</code> та <code>default</code> для точного керування виконанням.
            </p>
            <p>
                Ви можете використовувати <code>switch/case</code>, коли маєте багато варіантів, і вам потрібно визначити, який код виконувати на основі значення змінної. Практикуйте цю конструкцію, і вона стане корисною у ваших JavaScript-проектах.
            </p>
        </div>
    );
};
